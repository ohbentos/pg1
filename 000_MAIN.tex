...
% --------------------------------------------------- %
\newcommand{\TituloDoTCC}{\uppercase{Estudo de sistemas gerenciadores de bancos de dados (SGDB) para armazenamento de uma quantidade volumosa de grafos}}
\newcommand{\NomeDeAutor}{Mateus Bento Alves Vasconcellos}
\newcommand{\NomeOrientador}{Prof. Dr. Jorge Leonid Aching Samatelo}
\newcommand{\NomeCoorientador}{Profa. Dra. Maria da Penha}
...
%%%%%%%%%%%%%  R %%%%%%%%%%%%%%%
%%%%%%%%%%%%%  S %%%%%%%%%%%%%%%
\item[SGDB] Sistemas Gerenciadores de Banco de Dados
%%%%%%%%%%%%%  T %%%%%%%%%%%%%%%
%%%%%%%%%%%%%  U %%%%%%%%%%%%%%%
