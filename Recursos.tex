...
Os dados de grafos a serem utilizados nos testes foram gerados e
adquiridos por \citeonline{marcia}. São grafos que contém de dez
a vinte nós, projetados para simular redes ópticas.
% Os dados de grafos volumosos a serem utilizados nos testes serão
% de redes de telecomunicações gerados por \citeonline{marcia}.
