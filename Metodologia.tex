...
descritivo, visto que seus objetivos são a coleta, analise e
interpretação dos dados dados. Do ponto de vista dos
procedimentos técnicos, é classificado como experimental, dado
que, o trabalho busca identificar as variáveis do processo e suas
dependências, e, mediante analise quantitativa, obter conclusões
...
trabalho. O tempo total deste é de \DuracionPlanoMeses\ meses.
...
\ref{figDAGRTEMPACT001} é apresentado o diagrama de tempos das
