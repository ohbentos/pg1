...
De acordo com \citeonline{metodologia}, este trabalho pode ser classificado como aplicado, por tentar
solucionar um problema especifico em uma circunstância
particular. É classificada como descritiva, visto que seus
objetivos são a coleta, analise e interpretação dos dados dados. Do
ponto de vista dos procedimentos técnicos, é classificado como
...
%primeira atividade
\newcommand{\AtvAlgRotI}{Estudo sobre bancos de dados e otimizações}
%segunda atividade
...
%quinta atividade
\newcommand{\AtvAlgRotV}{Analise e discussão dos testes de perfomance}
%quinta atividade
