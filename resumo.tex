...
\begin{resumo}
    ...
    tempo de consulta e volume para cada uso específico.

    Ao mesmo tempo, a Teoria de Grafos emerge como um
    modelo eficaz, capaz de resolver, visualizar e armazenar
    problemas matemáticos, da engenharia, da computação e da
    indústria pela suas diversas aplicações práticas.
    ...
    volume utilizado para os principais tipos de consultas a
